...
│   ├── python files/                     # Core pipeline and validation scripts (incl. verify_backtest_v2.py and metrics_v2.py)
...
│   ├── python files/                     # Core deep learning and execution scripts (incl. verify_backtest_v2.py and metrics_v2.py)
...
│   ├── python files/                     # Event studies and execution scripts (incl. verify_backtest_v2.py and metrics_v2.py)
